...
Com essas ferramentas, conseguimos escalar nossas aplicações automaticamente de forma rápida e também, podemos adicionar critérios comuns para fazer escalonamento automático:
...
Dessa forma, simples, rápida e barata ("barato", só agulha na testa mesmo &#128517;) conseguimos aumentar a perfomance da nossa aplicação, lembrando que com novas soluções, vem novos problemas, nesse último diagrama podemos alguns gargalos/problemas que vão surgir:
