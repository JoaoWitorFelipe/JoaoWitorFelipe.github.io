...
Quero falar sobre escalonamento de API para dar um caminho inicial por onde começar, de uma forma barata, simples, rápida e mencionar algumas ferramentas comuns que oferecem isso. E também no final, mencioar algumas dificuldades dificuldades que vão aparecer após escalonarmos nossa API.
